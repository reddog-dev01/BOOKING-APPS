...
export function Sidebar({ links, appName = "FleetOps", open, onOpenChange }: SidebarProps) {
  ...
  return (
    <aside
      id="admin-sidebar"
      className="relative flex w-64 shrink-0 flex-col border-r border-border bg-card text-card-foreground transition-all duration-300 max-lg:absolute max-lg:z-50 max-lg:h-full max-lg:-translate-x-full max-lg:shadow-xl data-[open=true]:max-lg:translate-x-0"
      data-open={open}
    >
